      ...
      <div className="footer-inner">
        ...
        <div className="footer-bottom">
          ...
          <div className="social-row" aria-label="Social media links">
            <a href="https://instagram.com/conqueror_fitness_hub" target="_blank" rel="noopener noreferrer" className="soc-btn" aria-label="Follow us on Instagram">IG</a>
            <a href="https://wa.me/918669084921" target="_blank" rel="noopener noreferrer" className="soc-btn" aria-label="Chat with us on WhatsApp">WA</a>
            <a href="https://maps.app.goo.gl/Dt7G9R6vpVnsK47H9" target="_blank" rel="noopener noreferrer" className="soc-btn" aria-label="Find us on Google Maps">GM</a>
          </div>
        </div>
      </div>
    </footer>
